...
public class DataPm10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_pm10);
    ...
    void setChartData(){
        ...
        for (int i = 0; i < 10; i++) {
            ...
            String state = AirQuality.getLvl( AirQuality.AirQualityType.Pm10, value).getLvlStr();
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if (result.getInt("status") == NetConst.API_RESULT_SUCCESS) {
                                ...
                                if (data.length() < 2) {
                                    Toast.makeText(DataPm10Activity.this, "数据不足，生成图表失败", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    if(item.getString("pm10").isEmpty()){
                                        continue;
                                    }

                                    dataYList.add(Float.parseFloat(item.getString("pm10")));
                                    float value = Float.parseFloat(item.getString("pm10"));
