...
package com.rthc.freshair.willianchartview.view;
...
import com.rthc.freshair.willianchartview.listener.OnEntryClickListener;
import com.rthc.freshair.willianchartview.model.ChartEntry;
import com.rthc.freshair.willianchartview.model.ChartSet;
import com.rthc.freshair.willianchartview.view.animation.Animation;
import com.rthc.freshair.willianchartview.view.animation.style.BaseStyleAnimation;
	...
	private void digestData() {
		...
		for(ChartSet set: data){
			for(int i = 0; i < nEntries; i++){
				set.getEntry(i).setCoordinates(horController.parsePos(i, set.getValue(i)),
				...
				if(mSetClicked != -1 &&
					...
					if(mRegions.get(mSetClicked).get(mIndexClicked)
						...
						if(mEntryListener != null){
							Rect r = new Rect(getEntryRect(mRegions.get(mSetClicked).get(mIndexClicked)));
